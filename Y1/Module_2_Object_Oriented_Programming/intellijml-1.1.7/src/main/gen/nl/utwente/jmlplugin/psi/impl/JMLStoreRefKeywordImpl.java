...
public class JMLStoreRefKeywordImpl extends ASTWrapperPsiElement implements JMLStoreRefKeyword {

  public JMLStoreRefKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JMLVisitor visitor) {
    visitor.visitStoreRefKeyword(this);
  }
