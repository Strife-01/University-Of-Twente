...
public class JMLAssumeStatementImpl extends ASTWrapperPsiElement implements JMLAssumeStatement {

  public JMLAssumeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JMLVisitor visitor) {
    visitor.visitAssumeStatement(this);
  }
