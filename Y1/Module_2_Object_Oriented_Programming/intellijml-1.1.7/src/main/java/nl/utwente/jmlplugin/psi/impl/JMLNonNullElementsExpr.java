...
public class JMLNonNullElementsExpr extends ASTWrapperPsiElement {

    public JMLNonNullElementsExpr(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull JMLVisitor visitor) {
        visitor.visitNonNullElementsExpr(this);
    }
